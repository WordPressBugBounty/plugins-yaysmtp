...
namespace YaySMTPScoped\YayCommerce\AdminShell\License;

use YaySMTPScoped\YayCommerce\AdminShell\License\Contracts\LicenseConfigAdapter;
use YaySMTPScoped\YayCommerce\AdminShell\Support\Slug;
...
class LicenseHandler
{
    ...
    public static function remove_site_plugin_check(LicenseConfigAdapter $adapter): void
    {
        ...
        if (!function_exists('YaySMTPScoped\get_plugin_data')) {
