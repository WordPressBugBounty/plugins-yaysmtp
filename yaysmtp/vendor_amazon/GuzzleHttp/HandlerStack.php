...
class HandlerStack
{
    ...
    public static function create(?callable $handler = null)
    {
        ...
        $stack->push(\YaySMTP\Aws3\GuzzleHttp\Middleware::redirect(), 'allow_redirects');
        $stack->push(\YaySMTP\Aws3\GuzzleHttp\Middleware::cookies(), 'cookies');
        $stack->push(\YaySMTP\Aws3\GuzzleHttp\Middleware::prepareBody(), 'prepare_body');
        return $stack;
    }
    /**
