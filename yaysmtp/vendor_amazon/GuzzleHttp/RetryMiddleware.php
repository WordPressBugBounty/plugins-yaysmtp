...
class RetryMiddleware
{
    ...
    private function onFulfilled(\YaySMTP\Aws3\Psr\Http\Message\RequestInterface $req, array $options)
    {
    ...
    private function onRejected(\YaySMTP\Aws3\Psr\Http\Message\RequestInterface $req, array $options)
    {
