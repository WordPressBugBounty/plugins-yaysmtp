 ...
 */
class Uri implements \YaySMTP\Aws3\Psr\Http\Message\UriInterface
{
    /**
     ...
     * @return bool
     */
    public static function isDefaultPort(\YaySMTP\Aws3\Psr\Http\Message\UriInterface $uri)
    {
     ...
     */
    public static function isAbsolute(\YaySMTP\Aws3\Psr\Http\Message\UriInterface $uri)
    {
     ...
     */
    public static function isNetworkPathReference(\YaySMTP\Aws3\Psr\Http\Message\UriInterface $uri)
    {
     ...
     * @link https://tools.ietf.org/html/rfc3986#section-4.2
     */
    public static function isAbsolutePathReference(\YaySMTP\Aws3\Psr\Http\Message\UriInterface $uri)
    {
     ...
     * @link https://tools.ietf.org/html/rfc3986#section-4.2
     */
    public static function isRelativePathReference(\YaySMTP\Aws3\Psr\Http\Message\UriInterface $uri)
    {
        return $uri->getScheme() === '' && $uri->getAuthority() === '' && (!isset($uri->getPath()[0]) || $uri->getPath()[0] !== '/');
    }
    /**
    ...
    {
        return \YaySMTP\Aws3\GuzzleHttp\Psr7\UriResolver::removeDotSegments($path);
    }
    /**
     ...
     */
    public static function resolve(\YaySMTP\Aws3\Psr\Http\Message\UriInterface $base, $rel)
    {
        if (!$rel instanceof UriInterface) {
            $rel = new self($rel);
        }
        return \YaySMTP\Aws3\GuzzleHttp\Psr7\UriResolver::resolve($base, $rel);
    }
    /**
     ...
     * @return UriInterface
     */
    public static function withoutQueryValue(\YaySMTP\Aws3\Psr\Http\Message\UriInterface $uri, $key)
    {
     ...
     * @return UriInterface
     */
    public static function withQueryValue(\YaySMTP\Aws3\Psr\Http\Message\UriInterface $uri, $key, $value)
    {
        $current = $uri->getQuery();
        if ($current === '') {
            $result = [];
